...
You can find the user class in the file: _vendor/Donotgowiththeflow/authentication/src/Donotgowiththeflow/Authentication/Models/User.php_
...
Then go in _vendor/Donotgowiththeflow/authentication_ folder and run the command: `phpunit`.
<br/>
