...
<head>
    ...
    {!!  HTML::style('packages/Donotgowiththeflow/laravel-authentication-acl/css/bootstrap.min.css')  !!}
    {!!  HTML::style('packages/Donotgowiththeflow/laravel-authentication-acl/css/style.css')  !!}
    {!!  HTML::style('packages/Donotgowiththeflow/laravel-authentication-acl/css/strength.css')  !!}
    {!!  HTML::style('//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css')  !!}
    {!!  HTML::style('packages/Donotgowiththeflow/laravel-authentication-acl/css/fonts.css')  !!}
...
<div class="container">
  ...
  {{-- Js files --}}
  {!! HTML::script('packages/Donotgowiththeflow/laravel-authentication-acl/js/vendor/jquery-1.10.2.min.js') !!}
  {!! HTML::script('packages/Donotgowiththeflow/laravel-authentication-acl/js/vendor/password_strength/strength.js') !!}
